defmodule AppPlannerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AppPlannerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AppPlannerWeb.Gettext, "errors", msg, opts)
    end
  end
