    ...
    <div class="max-w-6xl mx-auto py-12 px-6">
        ...
        <div>
          ...
          <div class="flex items-center gap-3">
            ...
            <p class="text-base-content/40 text-[10px] font-black uppercase tracking-widest font-medium italic">
              Shared environments for projects
            </p>
          </div>
        </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        <%= for workspace <- @workspaces do %>
          <div
            ...
            class="group bg-base-100 border border-base-200 rounded-lg p-8 cursor-pointer hover:border-primary transition-all duration-500 hover:shadow-md relative overflow-hidden"
          >
            ...
            <div class="flex items-center justify-between relative">
              ...
              <div class="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                <.link
                  ...
                  class="btn btn-ghost btn-xs btn-circle bg-base-100 border border-base-200 hover:text-primary"
                  phx-click-stop
                >
              ...
              <div class="flex items-center gap-2">
                <div class="flex -space-x-1">
                  <div class="w-5 h-5 rounded-md bg-base-200 border border-base-100 flex items-center justify-center text-[8px] font-black uppercase">
                    {if workspace.owner,
                      do: String.at(workspace.owner.email, 0) |> String.upcase(),
                      else: "W"}
                  </div>
                </div>
                <span class="text-[9px] font-black uppercase text-base-content/20 tracking-widest italic ml-1">
                  Workspace Active
                </span>
              </div>
              <.link
                navigate={~p"/workspaces/#{workspace.id}/board"}
                class="text-[10px] font-bold uppercase text-primary tracking-widest opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0 transition-all duration-300"
              >
      ...
      <%= if Enum.empty?(@workspaces) do %>
        <div class="py-24 text-center border-4 border-dashed border-base-200 rounded-[3rem] bg-base-50/50">
          ...
          <p class="text-base-content/40 font-bold uppercase tracking-widest text-[11px]">
            No workspaces found
          </p>
          <.link
            navigate={~p"/workspaces/new"}
            class="mt-6 inline-block btn btn-primary btn-sm rounded-lg px-8 font-black uppercase text-[10px] tracking-widest shadow-lg shadow-primary/20"
          >
