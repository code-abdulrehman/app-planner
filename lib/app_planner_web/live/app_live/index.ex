               ...
               <div class="text-primary opacity-40 group-hover:opacity-100 transition-opacity">
                ...
                <div class="flex flex-col">
                  ...
                  <div class="flex gap-2 items-center flex-wrap text-[10px] text-gray-400">
                    ...
                    <!--
                    <div :if={app.app_members && length(app.app_members) > 0} class="dropdown dropdown-hover dropdown-end inline">
                    <span>•</span>
                      <label tabindex="0" phx-click-stop class="text-primary font-bold cursor-pointer hover:underline">
                        • <%= length(app.app_members) + 1 %> users
                      </label>
