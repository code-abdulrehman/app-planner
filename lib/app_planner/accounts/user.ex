defmodule AppPlanner.Accounts.User do
  use Ecto.Schema
  ...
  @doc """
  Changeset for updating full name (profile).
  """
  ...
  """
  def valid_password?(%AppPlanner.Accounts.User{hashed_password: hashed_password}, password)
